...
Do NOT return any additional content, explanations, or body text, even if it appears on the same line: only extract and return the valid legal heading.
  ...
  **Return the output as valid JSON in this format**:
  ...
  - Apply the CSS 'text-align: justify' style to all paragraph (<p>) elements and relevant text content to ensure that the text is aligned to both margins. This improves the readability and professional presentation of the document.
  ...
  - All text within HTML content should be justified using CSS ('text-align: justify') to align the text to both margins in a professional and legible manner.
